@extends('layouts.app')
@section('title', 'Quản lý bài viết nhóm')
@section('content')
...
<div class="mx-20 py-8">
    <h2 class="text-3xl font-semibold mb-8 text-center text-gray-800">Quản Lý Bài Viết Nhóm</h2>
        ...
        <table class="min-w-full w-full bg-white border border-gray-300">
            <thead class="bg-gray-200 text-gray-700 uppercase text-sm leading-normal">
                <tr>
                    ...
                    <th class="py-3 px-4 border-b font-semibold text-center">Nhóm đăng</th>
            ...
            <tbody>
                @foreach ($posts as $post)
                    <tr class="text-gray-700 hover:bg-gray-100">
                        ...
                        <td class="py-3 px-4 border-b w-96 text-center">{{ $post->noidung  ?? 'Không có nội dung'}}</td>
                        <td class="py-3 px-4 border-b text-center">
                        ...
                        <div id="deleteModal-{{ $post->id }}" class="fixed inset-0 bg-gray-500 bg-opacity-50 hidden flex items-center justify-center">
                            <div class="bg-white p-6 rounded shadow-lg w-1/3">
                                ...
                                <!-- Phần nhập lý do xóa -->
                                <form method="POST" action="{{ route('admin.posts_group.delete', $post->id) }}">
                                    @csrf
                                    @method('DELETE')
                                    <div class="mb-4">
